...
test('matching host rejects mismatched origin', async () => {
  const response = await fetch(`${server.baseUrl}/api/health`, { headers: { host: 'classwork.example', origin: 'https://other.example' } })
