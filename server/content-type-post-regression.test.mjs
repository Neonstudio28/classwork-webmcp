...
test('POST API requests reject non-JSON content', async () => {
  const response = await fetch(`${server.baseUrl}/api/generate`, { method: 'POST', headers: { 'content-type': 'text/plain' }, body: 'x' })
